...
public static unsafe partial class Vx
{
    ...
    /// </summary>
    [LibraryImport("Something", EntryPoint = "vx_array_clone")]
    public static partial VxArray Clone(this VxArray ptr);

    /// Free an owned <see cref="VxArray"/> object.
    [LibraryImport("Something", EntryPoint = "vx_array_free")]
    public static partial void Free(this VxArray ptr);

    /// <summary>
    /// Get the length of the array.
    /// </summary>
    [LibraryImport("Something", EntryPoint = "vx_array_len")]
    ...
    [LibraryImport("Something", EntryPoint = "ffi_primitive_array_new_u8")]
    public static partial VxArray PrimitiveArrayNew(in byte data, nuint length, IntPtr validity, ref VxError error);
    /// Create a new U16 primitive array from raw data. <br/>
    /// The `data` pointer must point to a valid array of `len` elements. <br/>
    /// The `validity` pointer, if not null, must point to a valid array of `len` booleans. <br/>
    /// If `validity` is null, the array is assumed to have no null values. <br/>
    /// Returns a new array, or null on error.
    [LibraryImport("Something", EntryPoint = "ffi_primitive_array_new_u16")]
    public static partial VxArray PrimitiveArrayNew(in ushort data, nuint length, IntPtr validity, ref VxError error);
    /// Create a new U32 primitive array from raw data. <br/>
    /// The `data` pointer must point to a valid array of `len` elements. <br/>
    /// The `validity` pointer, if not null, must point to a valid array of `len` booleans. <br/>
    /// If `validity` is null, the array is assumed to have no null values. <br/>
    /// Returns a new array, or null on error.
    [LibraryImport("Something", EntryPoint = "ffi_primitive_array_new_u32")]
    public static partial VxArray PrimitiveArrayNew(in uint data, nuint length, IntPtr validity, ref VxError error);
    /// Create a new U64 primitive array from raw data. <br/>
    /// The `data` pointer must point to a valid array of `len` elements. <br/>
    /// The `validity` pointer, if not null, must point to a valid array of `len` booleans. <br/>
    /// If `validity` is null, the array is assumed to have no null values. <br/>
    /// Returns a new array, or null on error.
    [LibraryImport("Something", EntryPoint = "ffi_primitive_array_new_u64")]
    public static partial VxArray PrimitiveArrayNew(in ulong data, nuint length, IntPtr validity, ref VxError error);
    /// Create a new i8 primitive array from raw data. <br/>
    /// The `data` pointer must point to a valid array of `len` elements. <br/>
    /// The `validity` pointer, if not null, must point to a valid array of `len` booleans. <br/>
    /// If `validity` is null, the array is assumed to have no null values. <br/>
    /// Returns a new array, or null on error.
    [LibraryImport("Something", EntryPoint = "ffi_primitive_array_new_i8")]
    public static partial VxArray PrimitiveArrayNew(in sbyte data, nuint length, IntPtr validity, ref VxError error);
    /// Create a new i16 primitive array from raw data. <br/>
    /// The `data` pointer must point to a valid array of `len` elements. <br/>
    /// The `validity` pointer, if not null, must point to a valid array of `len` booleans. <br/>
    /// If `validity` is null, the array is assumed to have no null values. <br/>
    /// Returns a new array, or null on error.
    [LibraryImport("Something", EntryPoint = "ffi_primitive_array_new_i16")]
    public static partial VxArray PrimitiveArrayNew(in short data, nuint length, IntPtr validity, ref VxError error);
    /// Create a new i32 primitive array from raw data. <br/>
    /// The `data` pointer must point to a valid array of `len` elements. <br/>
    /// The `validity` pointer, if not null, must point to a valid array of `len` booleans. <br/>
    /// If `validity` is null, the array is assumed to have no null values. <br/>
    /// Returns a new array, or null on error.
    [LibraryImport("Something", EntryPoint = "ffi_primitive_array_new_i32")]
    public static partial VxArray PrimitiveArrayNew(in int data, nuint length, IntPtr validity, ref VxError error);
    /// Create a new i64 primitive array from raw data. <br/>
    /// The `data` pointer must point to a valid array of `len` elements. <br/>
    /// The `validity` pointer, if not null, must point to a valid array of `len` booleans. <br/>
    /// If `validity` is null, the array is assumed to have no null values. <br/>
    /// Returns a new array, or null on error.
    [LibraryImport("Something", EntryPoint = "ffi_primitive_array_new_i64")]
    public static partial VxArray PrimitiveArrayNew(in long data, nuint length, IntPtr validity, ref VxError error);
    // /// Create a new f16 primitive array from raw data. <br/>
    // /// The `data` pointer must point to a valid array of `len` elements. <br/>
    // /// The `validity` pointer, if not null, must point to a valid array of `len` booleans. <br/>
    // /// If `validity` is null, the array is assumed to have no null values. <br/>
    // /// Returns a new array, or null on error.
    // [LibraryImport("Something", EntryPoint = "ffi_primitive_array_new_f16")]
    // public static partial VxArray PrimitiveArrayNewF16(in Half data, nuint length, IntPtr validity, ref VxError error);
    /// Create a new f32 primitive array from raw data. <br/>
    /// The `data` pointer must point to a valid array of `len` elements. <br/>
    /// The `validity` pointer, if not null, must point to a valid array of `len` booleans. <br/>
    /// If `validity` is null, the array is assumed to have no null values. <br/>
    /// Returns a new array, or null on error.
    [LibraryImport("Something", EntryPoint = "ffi_primitive_array_new_f32")]
    public static partial VxArray PrimitiveArrayNew(in float data, nuint length, IntPtr validity, ref VxError error);
    /// Create a new f64 primitive array from raw data. <br/>
    /// The `data` pointer must point to a valid array of `len` elements. <br/>
    /// The `validity` pointer, if not null, must point to a valid array of `len` booleans. <br/>
    /// If `validity` is null, the array is assumed to have no null values. <br/>
    /// Returns a new array, or null on error.
    [LibraryImport("Something", EntryPoint = "ffi_primitive_array_new_f64")]
    public static partial VxArray PrimitiveArrayNew(in double data, nuint length, IntPtr validity, ref VxError error);
    
    /// Write the UTF-8 string at `index` in the array into the provided destination buffer,
    /// recording the length in `len`.
    [LibraryImport("Something", EntryPoint = "vx_array_get_utf8")]
    ...
    /// the length in `len`.
    [LibraryImport("Something", EntryPoint = "vx_array_get_binary")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_array_iterator_free")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_array_iterator_next")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_dtype_new_utf8")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_dtype_new_binary")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_dtype_new_list")]
    ...
    /// Takes ownership of the `element` pointer.
    [LibraryImport("Something", EntryPoint = "vx_dtype_new_fixed_size_list")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_dtype_new_struct")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_dtype_new_decimal")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_dtype_struct_dtype")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_dtype_list_element")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_error_free")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_error_get_message")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_file_row_count")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_file_dtype")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_file_scan")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_set_log_level")]
    public static partial void SetLogLevel(VxLogLevel level);
    
    /// Free an owned <see cref="session"/> object.
    [LibraryImport("Something", EntryPoint = "vx_session_free")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_session_new")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_array_sink_open_file")]
    public static partial VxArraySink OpenFile(this VxSession session, [MarshalAs(UnmanagedType.LPStr)] string path, VxDType dType, VxError errorOut);
    ...
    [LibraryImport("Something", EntryPoint = "vx_array_sink_close")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_string_new_from_cstr")]
    public static partial VxString NewFromCStr([MarshalAs(UnmanagedType.LPStr)] string ptr);
    
    /// Return the length of the string in bytes.
    [LibraryImport("Something", EntryPoint = "vx_string_len")]
    public static partial void Length(VxString ptr);

    /// Return the pointer to the string data.
    [LibraryImport("Something", EntryPoint = "vx_string_ptr")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_struct_fields_field_name")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_struct_fields_field_dtype")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_struct_fields_builder_free")]
    public static partial void Free(this VxStructFieldsBuilder ptr);
    
    /// Create a new struct dtype builder.
    [LibraryImport("Something", EntryPoint = "vx_struct_fields_builder_new")]
    ...
    [LibraryImport("Something", EntryPoint = "vx_struct_fields_builder_add_field")]
    public static partial VxStructFieldsBuilder AddField(this VxStructFieldsBuilder builder, VxString name, VxDType dType);
    ...
    [LibraryImport("Something", EntryPoint = "vx_struct_fields_builder_finalize")]
